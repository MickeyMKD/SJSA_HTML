...
const connectionString = 'mongodb+srv://mickeymkd:mikiMiki007@cluster0.zryf5.mongodb.net/baza1?retryWrites=true&w=majority';
...
connect(connectionString)
    ...
    .then(res => {
        ...
        return Studenti.updateOne({_id: '62d6eedfc8bdb55e5e610e0c'}, {prezime: 'Petrovski'});
    })
    .then(res => {
        console.log('Update Finished!', res);
        // deleteMany() -> za brishenje po povekje parametri
        return Studenti.deleteOne({_id: '62d70aba1eb6c1cc8f027732'});
    })
    .then(res => {
